...
public class PlayerControlerOld : MonoBehaviour {
	...
	void Start () {
		...
		Debug.Log ("child : " + line.GetComponent<Transform> ().name);
		line.enabled = false;
	...
	IEnumerator FireLaser()
	{
		...
		{
			//transform.forward = playerCam.ScreenToWorldPoint(Input.mousePosition); //This rotates everything
